...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand navbar-brand-logos" href="index.php#page-top">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="btn btn-outline-light ms-3" href="index.php#register">Register</a></li>
                </ul>
            </div>
        </div>
    </nav>
